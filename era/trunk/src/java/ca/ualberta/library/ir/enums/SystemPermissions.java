 ...
 * Project: ir
 * $Id: SystemPermissions.java 5606 2012-10-10 16:45:09Z pcharoen $
 */
...
public enum SystemPermissions {
	...
	ADMIN_INDEX("/admin/index"), // build index
	ADMIN_RELOAD("/admin/reload"), // reload inputforms.xml
	ADMIN_PROQUEST("/admin/proquest"), // proquest upload
	ADMIN_SUBSCRIPTION("/admin/subscription"), // send subscription email
	ADMIN_EMBARGOED_PUBLISHER("/admin/embargoed/publisher"), // publish expired embargoed item
	ADMIN_FACEBOOK("/admin/facebook"), // post new item message to era facebook page
