<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/trunk/web/jsp/protected/embargoedItemList.jsp $
   $Id: embargoedItemList.jsp 5606 2012-10-10 16:45:09Z pcharoen $
