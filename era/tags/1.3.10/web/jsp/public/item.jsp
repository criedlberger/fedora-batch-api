<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/1.3.10/web/jsp/public/item.jsp $
   $Id: item.jsp 5427 2012-07-12 20:30:12Z pcharoen $
	...
	<stripes:layout-component name="contents">
		...
		<c:when test="${actionBean.item.properties.state == 'A'}">
			...
			<security:secure roles="/item/delete,/object/dark,/object/ccid">
				<a id="deleteItem" href="${ctx}/action/item/delete/${actionBean.pid}" class="delete_button" title="${appname}" 
					onclick="Modalbox.show($('confirmDelete'), {title: this.title, width: 400}); return false;"><fmt:message key="button.delete" /></a>
			</security:secure>
		</c:when>
		...
		<div class="full_info">
		<ul class="item_info" style="width: 30em; height: 100%;">
