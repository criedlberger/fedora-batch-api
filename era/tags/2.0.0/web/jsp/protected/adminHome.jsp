<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/protected/adminHome.jsp $
   $Id: adminHome.jsp 5615 2012-10-16 18:20:47Z pcharoen $
					...
					${n % 2 == 1 ? '<li>' : ''}
						<div>
							<span class="desc">
								...
								<h3>
									<a id="${id}" href="${ctx}${url}" onclick="${id == 'reload' || id == 'facebook' ? 'return false;' : 'return true;'}">
