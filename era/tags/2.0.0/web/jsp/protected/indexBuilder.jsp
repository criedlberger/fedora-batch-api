<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/protected/indexBuilder.jsp $
   $Id: indexBuilder.jsp 5615 2012-10-16 18:20:47Z pcharoen $
