<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/protected/myBookmarks.jsp $
   $Id: myBookmarks.jsp 5615 2012-10-16 18:20:47Z pcharoen $
	...
	<stripes:layout-component name="contents">
        ...
        <ol>
			<c:forEach items="${actionBean.results}" var="result" varStatus="status">
				<li class="record">
					<ir:item pid="${result['bm.pid']}" field="iresult">
