<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/protected/proquestUpload.jsp $
   $Id: proquestUpload.jsp 5615 2012-10-16 18:20:47Z pcharoen $
	...
	<stripes:layout-component name="contents">
		<div class="full_box">
			...
			<c:if test="${event == 'confirm'}">
				<stripes:form id="proquestForm" action="/action/admin/proquest">
					<table>
		                <tr>
