<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/protected/community.jsp $
			...
			<ul class="item_info" style="width: 50em;">
				...
				<li>
					...
					<div style="float: left;">
						...
						<a href="${ctx}/public/view/community/${actionBean.community.id}" class="browsebutton"><fmt:message key="toolbar.browse.label" /></a>
					</div>
