<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/2.0.0/web/jsp/public/item.jsp $
   $Id: item.jsp 5615 2012-10-16 18:20:47Z pcharoen $
		...
		<c:if test="${actionBean.item.properties.state != 'A' && !empty actionBean.item.properties.workflowState}">
			<div class="view_box">
				...
				<c:if test="${not empty actionBean.item.comments}">
					...
					<textarea style="width: 100%; height: 26em; background-color: #FFEDED;" readonly="readonly">${actionBean.item.comments}</textarea>
				</c:if>
