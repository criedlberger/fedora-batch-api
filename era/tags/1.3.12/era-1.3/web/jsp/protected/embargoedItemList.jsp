<!--
   $HeadURL: https://code.library.ualberta.ca/svn/repos/era/tags/1.3.12/era-1.3/web/jsp/protected/embargoedItemList.jsp $
   $Id: embargoedItemList.jsp 5427 2012-07-12 20:30:12Z pcharoen $
			...
			<c:forEach items="${actionBean.results}" var="result" varStatus="status">
				...
				<li class="record">
					...
					<div class="itemlist_actions">
						...
						<fmt:formatDate pattern="${actionBean.dateFormatShort}" value="${fld['era.embargoedDate_dt']}" /><br />
